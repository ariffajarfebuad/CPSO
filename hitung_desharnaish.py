...
# --------Desharnaish
tabelDesharnaish = []
print("Sedang Hitung Desharnaish...")
for j in range(len(jumlahPartikel)):
    ...
    for i in range(len(kodeJarak)):
        ...
        parameter = {
            ...
            "indexFitur": [1, 2, 4, 6, 7, 8, 9, 10, 11],
            # Maxwell(24,26) ,Desharnais(8,5) ,Silhavy(11,12)
            "posisiSize": 8,
            "posisiEffortAktual": 5,
...
print("tabelDesharnais:"), print(tabelDesharnaish)
...
for i in range(len(tabelDesharnaish)):
    for j in range(len(tabelDesharnaish[i])):
        if j == 0:
            ...
            print("Euclidien-------:", tabelDesharnaish[i][j])
        elif j == 2:
            print("Manhattan-------:", tabelDesharnaish[i][j])
        elif j == 3:
            print("Minkowski-------:", tabelDesharnaish[i][j])
