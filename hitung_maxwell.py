...
class Analogy:
    ...
    def main_analogy(self):
        ...
        for x in range(len(dataset)):
            ...
            # print(pBestEstimasi[index_partikel])
            
            # print(pBestEstimasi)
            print(estimasiEffort)
            sys.exit()
...
for j in range(len(jumlahPartikel)):
    ...
    for i in range(len(kodeJarak)):
        ...
        parameter = {
            ...
            "posisiSize": 24,
            "posisiEffortAktual": 26,
            # [1]Maxwell, [2]Desharnais, [3]Silhavy, [4]Silhavy2
            "namaDataset": 1
        }
        maxwell = Analogy(parameter)
        hasil = maxwell.main_analogy()
    ...
    # print(temp)
    tabelMaxwell.append(temp)

print("Hitung Maxwell Selesai")

print("======= Maxwell======")
for i in range(len(tabelMaxwell)):
    for j in range(len(tabelMaxwell[i])):
        if j == 0:
            print("Jumlah Partikel-:", tabelMaxwell[i][j])
        elif j == 1:
            print("Euclidien-------:", tabelMaxwell[i][j])
        elif j == 2:
            print("Manhattan-------:", tabelMaxwell[i][j])
        elif j == 3:
            print("Minkowski-------:", tabelMaxwell[i][j])
print()
